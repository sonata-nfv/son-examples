...
# apache bench vnf
docker build -t $target_repo/sonata-apache-bench-vnf -f sonata-apache-bench-vnf-docker/Dockerfile sonata-apache-bench-vnf-docker

# apache server vnf
docker build -t $target_repo/sonata-apache-server-vnf -f sonata-apache-server-vnf-docker/Dockerfile sonata-apache-server-vnf-docker
